...
function showWelcomeBotMsg(){
    var options = {
        ...
        msgContainerId: '#chatContent',
        textMsg: "Hi, Sara.<br> It is so good to see you again  "
    };
    showMustacheTemplateText(options);
...
function respnseFromText(textVal){
    ...
    var stringFound3 = checkString(textVal.toLowerCase(),'upcoming appointment');
    console.log(textVal)
//    if(stringFound1){
//        var options = {
...
$(".sliderContainer").each(function(){
    ...
    var boxCount = $(this).find(".sliderContainer").length;
