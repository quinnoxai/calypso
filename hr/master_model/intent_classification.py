...
#BASE_DIR1 = 'D:/projects/myvenv/Kaya_helpdesk/'
#unpickling intent data
# hrhelpdesk/master_model/training_data_master
# print(os.path.join(BASE_DIR,r'training_data'))
data = pickle.load( open(os.path.join(BASE_DIR,r'hr/master_model/training_data_master'),"rb" ))
# data = pickle.load(open("training_data_master","rb" ))
words = data['words']
...
with open(os.path.join(BASE_DIR,r'hr/master_model/intent_new.json'),encoding="utf-8")as json_data:
...
check_in = "./checkpoints_master/master_model.ckpt"
...
with g1.as_default():
    ...
    model = tflearn.DNN(net, tensorboard_dir='tflearn_logs', checkpoint_path=check_in)
...
with g1.as_default():
    model.load(os.path.join(BASE_DIR,r'hr/master_model/master_model.tflearn'))
    # model.load('master_model.tflearn')
...
# print(extract_extity("Show me something on agriculture",classify("Show me something on agriculture")))
# print("master model",classify("leaves"))