...
#print(os.path.join(BASE_DIR,r'hr/lnd_model/training_data'))
# hrhelpdesk/leave_model/leave_model.tflearn.data-00000-of-00001
data = pickle.load(open(os.path.join(BASE_DIR,r'hr/trial_model/training_data_trial'),"rb" ))
#data = pickle.load('training_data_lnd',"rb" )
words = data['words']
...
check_in = "./checkpoints_trial/trial_model.ckpt"
...
with g1.as_default():
    model.load(os.path.join(BASE_DIR,r'hr/trial_model/trial_model.tflearn'))
...
#print("posh model",classify("Why termed as POSH?"))
# print(response("How to apply for leave?"))
